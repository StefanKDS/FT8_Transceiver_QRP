...
// ---------------------------------------------------------------------------
// Part 2 & 3 & 4 (UI, controls, workflow) unchanged except pin/register fixes
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Part 4 (settings, loop, main) - only adjustments: CPU speed no-op and pin checks
// ---------------------------------------------------------------------------
...
void loop()
{
    ...
    agcEvent = btn_AGC.checkEvent(::agcEvent);
    ...
    stepEvent = btn_Step.checkEvent(::stepEvent);
